...
Ext.define('Ext.data.Model', {
    ...
    addAssociations: function(associations, defaultType) {
        ...
        for (i = 0, ln = associations.length; i < ln; i++) {
            ...
            Ext.ClassManager.onCreated(function(associationName) {
                var i = 0,
                    ln = associations.length;

                for (i = 0; i < ln; i++) {
                    if (associations[i].associatedModel == associationName) {
                        associationsCollection.add(Ext.data.association.Association.create(associations[i]));
                        break;
                    }
                }
